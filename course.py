...
class courseClass:
    def __init__(self,root):
        ...
        #===WIdges===
        lbl_courrseName=Label(self.root,text="Course Name",font=("goudy old style",15,'bold'),bg="white").place(x=10,y=60)
        ...
        lbl_search_courrseName=Label(self.root,text="Course Name:",font=("goudy old style",15,'bold'),bg="white").place(x=720,y=60)    
            ...
            if self.var_course.get()=="":
                ...
                if row==None:
                    ...
                    if op==True:
                       ...
                       con.commit()
                       messagebox.showinfo("Delete","Course delete successfuly",parent=self.root)
                       self.clear()
    ...
    def update(self):
        ...
        try:
            if self.var_course.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                       messagebox.showerror("Error","select coure from list",parent=self.root)
                else:
                       ...
                       con.commit()
                       messagebox.showinfo("Success","Course upated Successfully",parent=self.root)
                       self.show()
        except  Exception as ex:
            messagebox.showerror("Error",f"Error due to{str(ex)}")     
