...
class resultClass:
    def __init__(self,root):
        ...
        lbl_marks_ob=Label(self.root,text="Mark Obtained",font=("goudy old style",15,"bold"),bg="white").place(x=50,y=280)
        ...
        self.btn_clear=Button(self.root,text="clear",font=("times new roman",15),bg="lightgray",activebackground="lightgray",cursor="hand2",command=self.clear) 
