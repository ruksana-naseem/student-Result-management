...
class reportClass:
    def __init__(self,root):
        ...
        btn_search=Button(self.root,text="search",font=("goudy old style",15,"bold"),bg="#2196f3",fg="white",cursor="hand2",command=self.search).place(x=660,y=100,width=100,height=35)
        btn_clear=Button(self.root,text="clear",font=("goudy old style",15,"bold"),bg="gray",fg="white",cursor="hand2",command=self.clear).place(x=780,y=100,width=100,height=35)
        ...
        lbl_marks_ob=Label(self.root,text="Mark Obtained",font=("goudy old style",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=600,y=230,width=150,height=50)
        ...
        try:
            if self.var_search.get()=="":
                ...
                if row!=None:
                    ...
                    messagebox.showerror("Error","No record find",parent=self.root)       
            ...
            if self.var_id=="":
                ...
                if row==None:
                    ...
                    if op==True:
                       ...
                       con.commit()
                       messagebox.showinfo("Delete","Result delete successfuly",parent=self.root)
                       self.clear()
